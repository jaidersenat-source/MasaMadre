@extends('layouts.app')
@section('title', 'Editar panadería')
...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-8">
        ...
        <h1 class="font-display text-3xl font-bold text-corteza">Editar panadería</h1>
        <p class="text-corteza/50 text-sm mt-1">Se actualizarán los datos de la panadería y su usuario de acceso</p>
    </div>
    ...
    <form method="POST" action="{{ route('admin.panaderias.update', $panaderia->id) }}" class="space-y-6">
        @csrf
        @method('PATCH')
        ...
        <div class="card p-6">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="nombre" value="{{ old('nombre', $panaderia->nombre) }}"
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="ciudad" value="{{ old('ciudad', $panaderia->ciudad) }}"
                               placeholder="NEIVA"
                    ...
                    <div>
                        ...
                        <input type="text" name="direccion" value="{{ old('direccion', $panaderia->direccion) }}"
                ...
                <div>
                    ...
                    <select name="regional"
                        ...
                        @foreach($regionales as $r)
                            <option value="{{ $r }}" {{ old('regional', $panaderia->regional) === $r ? 'selected' : '' }}>
                                {{ $r }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <input type="text" name="centro_formacion" value="{{ old('centro_formacion', $panaderia->centro_formacion) }}"
                ...
                <div>
                    ...
                    <input type="text" name="extensionista" value="{{ old('extensionista', $panaderia->extensionista) }}"
        ...
        <div class="card p-6">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="user_name" value="{{ old('user_name', $panaderia->users->first()->name ?? '') }}"
                ...
                <div>
                    ...
                    <input type="email" name="user_email" value="{{ old('user_email', $panaderia->users->first()->email ?? '') }}"
